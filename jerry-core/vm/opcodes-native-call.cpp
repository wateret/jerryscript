...
{
  const vm_idx_t dst_var_idx = instr.data.native_call.lhs;
  const vm_idx_t native_call_id_idx = instr.data.native_call.name;
  const vm_idx_t args_number = instr.data.native_call.arg_list;
